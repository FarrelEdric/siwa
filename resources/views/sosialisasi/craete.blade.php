...
<div class="card card-outline">
    ...
    <div class="card-body">
        <form method="POST" action="{{ url('sosialisasi') }}" class="form-horizontal">
            @csrf
            <div class="form-group">
                <label for="nama_sosialisasi" class="control-label">Nama</label>
                <div class="mt-2">
                    <input type="text" class="form-control" id="nama_sosialisasi" name="nama_sosialisasi" value="{{ old('nama_sosialisasi') }}" required>
            ...
            <div class="form-group">
                ...
                <div class="mt-2">
                    <input type="text" class="form-control" id="ket_sosialisasi" name="ket_sosialisasi" value="{{ old('ket_sosialisasi') }}" required>
